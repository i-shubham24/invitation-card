...
const FORM_BOX = { x: 20.37, y: 89.74, w: 60.44 }
...
export default function FigmaCanvasDesktop({ onRsvpSaved, opened }) {
  ...
  return (
    <div className="figd" style={{ aspectRatio: `${CANVAS_D.w} / ${CANVAS_D.h}` }}>
      ...
      <Item it={{ id: 'msg1', kind: 'img', z: 89, x: -5, y: 78.67, w: 58.5, h: 3.14, src: '/figma/msg1.png', contain: true }} />
      <Item it={{ id: 'msg3', kind: 'img', z: 89, x: 5, y: 78.67, w: 81.0, h: 3.67, src: '/figma/msg3.png', contain: true }} />
      <Item it={{ id: 'msg2', kind: 'img', z: 89, x: 17.5, y: 79.42, w: 83.5, h: 4.44, src: '/figma/msg2.png', contain: true }} />
      ...
      <ScallopPanel x={5.526} y={87.99} w={85.992} h={5.80} vbh={935} />
      ...
      <NoteCard style={{ top: '81.56%', width: '51%', left: '24.5%' }} />
